...
echo "We'll be backing up the production site for Gwyndows.com here. Let's get started. "
echo
echo "-----------------------------------------------------------"

cd $SERVER
echo
read -n1 -r -p "REMINDER: We are about to work on $SERVER - press Y to continue... " KEY
