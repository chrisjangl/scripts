...
echo "We'll be looping through the sites in Social Digital and creating a new branch for updates. Let's get started. "
echo
echo "-----------------------------------------------------------"
read -p "What should we call the branch? " -e BRANCHNAME
